...
The :mod:`esmpy.models.absorption_edxs` module implements the functions to calculate the contribution of absorption in edx spectra.
...
def det_efficiency_from_curve (x,filename,kind = "cubic") :
    r"""
    Interpolate a detection efficiency curve that is stored in ~/esmpy/tables.
...
def det_efficiency (x,det_dict) :
    ...
    >>> from esmpy.models.absorption_edxs import det_efficiency
